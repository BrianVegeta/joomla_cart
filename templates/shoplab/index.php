...
$sitetitle = $this->params->get("sitetitle", "ShopLab Free VirtueMart Theme Template - Linelab.org"); 
?>
...
<div class="currency"><jdoc:include type="modules" name="currency" style="none"/></div><jdoc:include type="modules" name="cart" style="none"/>
       </div>
        <div id="sub-panel">
<a href="#"><img src="<?php echo $this->baseurl ?>/templates/shoplab/images/carttop.png" alt="" /></a>
</div></div>
	            <div class="logo">	
    	    <a href="index.php" id="logo" title="<?php echo $sitetitle ?>" ><img src="<?php echo $this->baseurl ?>/templates/shoplab/images/logo.png" alt="" /></a>
	      </div>
...
<img alt="" src="templates/shoplab/images/pravy.png" />
</div>	
...
<div class="component"><div class="breadcrumbs-pad">
		...
		Copyright&nbsp;&copy; <?php echo date( '2010 - Y' ); ?> <?php echo $sitetitle; ?>. <a href="http://templatefreejoomla.com/" title="Download Joomla templates">Joomla templates</a> Design by <a target="_blank"  href="http://www.linelab.org/">linelab</a>
    </div>
    <div id="debug">
